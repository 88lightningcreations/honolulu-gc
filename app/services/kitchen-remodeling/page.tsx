...
import styles from './KitchenRemodeling.module.css';
      ...
      <article className={styles.article}>
        <section>
          ...
          <ul>
            ...
            <li><strong>Connection to the outdoors:</strong> Large windows, sliding glass doors, and pass-through windows create a seamless connection to the lanai or outdoor living space, making it easy to entertain and enjoy the beautiful Hawaiian weather.</li>
            <li><strong>High-end appliances:</strong> Modern, energy-efficient appliances not only look great but can also make your life easier and save you money on your energy bills.</li>
            <li><strong>Ample storage:</strong> A well-designed kitchen should have plenty of storage to keep your countertops clutter-free. Custom cabinetry, pantries, and islands with built-in storage are all great options.</li>
          </ul>
        </section>
        <section>
          ...
          <ol>
            ...
            <li><strong>Demolition and Construction:</strong> Once the permits are in hand, the demolition and construction can begin. This is where your old kitchen will be torn out and the new one will be built.</li>
        ...
        <CostEstimator preselectedService="kitchen-remodeling" />
